...
do
	...
	if [ $i -lt 10 ]; then
	    ...
	    python main.py --model dpn3d26 -b 1 --resume results/dpn3d26/retrft96$f/CkptFile/0$i.ckpt --test 1 --save-dir dpn3d26/retrft96$f/ --config config_trainingpy3$f --gpu=0
	elif [ $i -lt 1000 ]; then
	    python main.py --model dpn3d26 -b 1 --resume results/dpn3d26/retrft96$f/CkptFile/$i.ckpt --test 1 --save-dir dpn3d26/retrft96$f/ --config config_trainingpy3$f --gpu=0
	else
	    echo "Unhandled case"
    fi
