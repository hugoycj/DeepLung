...
# results_path = '../detector/results/fpn3d/retrft96' + str(fold) + '/val'#val' #val' ft96'+'/val'#
results_path = '../detector/results/dpn3d26/retrft96' + str(fold) + '/val'#val' #val' ft96'+'/val'#
maxeps = 90 #03 #150 #100#100
...
# maxeps = 715 #03 #150 #100#100

eps = range(maxeps, maxeps+1, 1)#6,7,1)#5,151,5)#5,151,5)#76,77,1)#40,41,1)#76,77,1)#1,101,1)#17,18,1)#38,39,1)#1, maxeps+1, 1) #maxeps+1, 1)
detp = [-2, -3, -4]#, -0.5, 0]#, 0.5, 1]#, 0.5, 1] #range(-1, 0, 1)
isvis = True
nmsthresh = 0.1
nprocess = 8
use_softnms = False
